...
There are a number of other transaction and block replay Flowables described in [Listening to Events](../advanced/filters_and_events.md).
...
For further information refer to [Listening to Events](../advanced/filters_and_events.md) and the [Web3jRx](https://github.com/web3j/web3j/blob/master/core/src/main/java/org/web3j/protocol/rx/Web3jRx.java) interface.
